...
public class RestfulController {
  ...
  public Repository getRepo(@PathVariable("repo") String name,
  ...
  public List<Issue> getIssueList(@PathVariable("repo") String repo,
      @PathVariable("author") String author) {
    Repository repository = repoRepository.findRepositoriesByNameAndAuthor(repo, author).get(0);
  ...
  public List<Release> getReleaseList(@PathVariable("repo") String repo,
      @PathVariable("author") String author) {
    Repository repository = repoRepository.findRepositoriesByNameAndAuthor(repo, author).get(0);
  ...
  public List<Commit> getCommitList(@PathVariable("repo") String repo,
      @PathVariable("author") String author) {
    Repository repository = repoRepository.findRepositoriesByNameAndAuthor(repo, author).get(0);
